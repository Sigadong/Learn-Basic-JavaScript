...
const detectTriangles = detectTriangle('a', 3, 2);
console.log(detectTriangles);


/*
Pada modul ini kita mempelajari bagaimana menangani kemungkinan eror pada program agar tidak mengalami crash.
